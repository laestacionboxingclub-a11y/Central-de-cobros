...
import { PanelDueno } from './panel/PanelDueno'

const ROLES_PERMITIDOS = ['dueno']
const ETIQUETA_APP = 'Panel del Dueño'
...
function Contenido() {
  ...
  return <PanelDueno perfil={perfil} tenant={tenant} onLogout={logout} />
}
